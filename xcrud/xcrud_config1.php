...
{
    // default connection
    public static $dbname = 'emcaustr_studentmgmt'; // Your database name
    ...
    public static $column_cut = 30000; // Sets the maximum number of characters in the column.
    ...
    // alert settings
    public static $email_from = 'studyabroad@emcaustralia.com.au'; // email from address
    public static $email_from_name = 'Study Abroad EMC Australia'; // email from name
