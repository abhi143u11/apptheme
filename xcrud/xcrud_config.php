...
{
    // default connection
    public static $dbname = 'proposal'; // Your database name
    ...
    // alert settings
    public static $email_from = 'support@emcaustralia.com.au'; // email from address
    public static $email_from_name = 'Support EMC Australia'; // email from name
